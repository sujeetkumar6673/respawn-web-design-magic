...
const WelcomeMessage: React.FC<WelcomeMessageProps> = ({ userName }) => {
  return (
    <Card className="bg-white rounded-xl p-1.5 flex items-center gap-1.5">
      <div className="relative">
        <Avatar className="h-8 w-8 border-2 border-rezilia-blue">
      ...
      <div className="text-left">
        <h2 className="text-sm font-bold">HELLO, {userName.toUpperCase()}</h2>
