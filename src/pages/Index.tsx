      ...
      <div className="flex h-full overflow-hidden">
        ...
        <div className={`flex-1 p-2 flex flex-col overflow-hidden ${isMobile ? 'w-full' : 'ml-[220px]'}`}>
          <div className="max-w-[1200px] mx-auto flex flex-col h-full overflow-hidden">
            ...
            {/* Main Dashboard */}
            <div className="bg-white rounded-b-xl p-2 flex-1 overflow-hidden">
                    ...
                    <div className="space-y-2 pb-2">
                      ...
                      {isMobile && (
                        <section className="mt-1 mb-2">
                          <h2 className="text-sm sm:text-base font-bold mb-1">Calendar & Schedule</h2>
                          <CalendarProvider>
                      ...
                      {/* Modules Section */}
                      <section>
                        <h2 className="text-sm sm:text-base font-bold mb-1">Modules</h2>
                        <ModulesSection />
                      </section>
                      ...
                      {/* Resources Section */}
                      <section className="mt-2">
                        <h2 className="text-sm sm:text-base font-bold mb-1">Resources</h2>
                        <ResourcesSection />
                      </section>
                    </div>
                  </ScrollArea>
