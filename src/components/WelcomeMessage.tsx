...
const WelcomeMessage: React.FC<WelcomeMessageProps> = ({ userName }) => {
  return (
    <Card className="bg-white rounded-md p-2 md:p-3 flex items-center gap-2 md:gap-3 mb-2 md:mb-3">
      <div className="relative">
        <Avatar className="h-8 w-8 md:h-10 md:w-10 border border-rezilia-blue">
      ...
      <div className="text-left">
        <h2 className="text-xs md:text-sm font-bold">HELLO, {userName.toUpperCase()}</h2>
